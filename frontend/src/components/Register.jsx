  ...
  return (
    ...
    <div className='w-full max-w-sm mx-auto shadow-md rounded px-8 pt-6 pb-8 mb-4'>
        ...
        <div className='mt-4'>
            ...
            className='w-full bg-blue-800 flex flex-wrap gap-1 items-center justify-center hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none'>
            <FaGoogle  className='mr-2'/>
            Sign in with Google
            </button>
        </div>
        <p className='mt-5 text-center text-gray-500 text-xs'> {currentYear} Book Store. All rights reserved</p>
    </div>
</div>
  )
}
